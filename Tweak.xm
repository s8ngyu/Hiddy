...
- (BOOL)isIconVisible:(SBApplicationIcon *)icon {
  ...
  if([SparkAppList doesIdentifier:@"com.peterdev.hiddy.plist" andKey:@"hide" containBundleIdentifier:bundleIdentifier]) // This returns TRUE if the bundle identifer exists
  {
